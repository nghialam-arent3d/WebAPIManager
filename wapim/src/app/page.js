      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-center min-h-screen py-12">
          ...
          <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            <div className="pt-6">
              <div className="flow-root bg-white/80 backdrop-blur-sm rounded-xl border border-[#d4cdb7] px-6 pb-8">
                <div className="-mt-6">
                  <div className="inline-flex items-center justify-center p-3 bg-[#5c8d89] rounded-md shadow-lg">
                    <svg className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                    </svg>
                  </div>
                  <h3 className="mt-8 text-lg font-medium text-[#2d4544] tracking-tight">Secure Key Management</h3>
                  <p className="mt-5 text-base text-[#5c8d89]">
            ...
            <div className="pt-6">
              <div className="flow-root bg-white/80 backdrop-blur-sm rounded-xl border border-[#d4cdb7] px-6 pb-8">
                <div className="-mt-6">
                  ...
                  <h3 className="mt-8 text-lg font-medium text-[#2d4544] tracking-tight">Usage Analytics</h3>
                  <p className="mt-5 text-base text-[#5c8d89]">
            ...
            <div className="pt-6">
              <div className="flow-root bg-white/80 backdrop-blur-sm rounded-xl border border-[#d4cdb7] px-6 pb-8">
                <div className="-mt-6">
                  ...
                  <h3 className="mt-8 text-lg font-medium text-[#2d4544] tracking-tight">Rate Limiting</h3>
                  <p className="mt-5 text-base text-[#5c8d89]">
